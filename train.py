...
# model.load_state_dict(torch.load('Weights/epochs/epoch_5', map_location = device))
...
#         # torch.save(model.state_dict(), 'Weights/epoch_' + str(epoch + 1) + '_' + str(A) + '_' + str(B) + '_' + str())
        torch.save(model.state_dict(), 'Weights/epochs/epoch_' + str(epoch + 1))
    ...
    if ((epoch + 1) % 5 == 0):
        ...
        torch.save(model.state_dict(), 'Weights/epoch_' + str(epoch + 1) + '_' + str(met))
